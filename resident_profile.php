  ...
  background-color: #1d4ed8; /* Tailwind blue-700 color */
    ...
    <body> 
        ...
        <nav class="navbar navbar-dark custom-blue sticky-top">
            ...
            <a class="navbar-brand" href="resident_homepage.php" style="margin-left:10px;"><b>BARANGAY EAST MODERN SITE Information System</b></a>
        ...
        <div class="container"> 
            <div class="card" style="margin-top: 2em;">  
                    <div class="card-header bg-primary text-black" style="font-size:20px"> Personal Information </div>
                <div class="card-body"> 
                    <form method="post">
                        ...
                        <div class="row" style="margin-bottom: 5px;"> 
                            <div class="col-xl-12">
                                <div class="form-inline">
                                    ...
                                    <button class="btn btn-secondary" style="margin-left: .2%; width:143px;" type="submit" name="profile_update"> Update </button>
                            ...
                            <li>
                                <div class="zoom">
                                    ...
                                    <img src="assets/logos.png" alt="Person" width="96" height="96" style="border-radius: 50%;">
                                        Barangay Calubang | (046) 509 1644
                                    </div>
                                </div>
                            </li>
                        </ul>
