<?php
   ...
   $bmis->validate_admin();
   $view = $residentbmis->view_resident_hof();
...
<div class="container-fluid">
    ...
    <div class="row"> 
        <div class="col-md-12">
            <form method="POST" action="">
                ...
                <a href="admn_hof.php" style="width: 90px; font-size: 18px; border-radius:30px;" class="btn btn-info">Reload</a>
            </form>
            <br>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-8"> 
            <?php 
                include('admn_table_hof_search.php');
            ?>
        </div>
        <div class="col-md-2"> </div>
    </div>
