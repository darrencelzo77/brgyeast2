    ...
    <div class="col-xs-12 col-sm-6 col-md-8">
        <div style="width: 100%; height:100%; max-height: 1000px;">
            ...
            <div style="background-image: url('assets/logos.png'); background-size: cover;
                ...
                <p class="print-padding" style="text-indent:40px;text-align: justify;">This is to certify that <b><?= $lname ?>, <?= $fname ?> <?= $mi ?></b>, <b><?= $age ?></b> years old belongs to indigent family of <b><?= $houseno ?> <?= $street ?></b>, East Modern Site Barangay, City of Bagiuo, BENGUET.</p>
