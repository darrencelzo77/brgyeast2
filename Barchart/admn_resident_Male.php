<?php
    ...
    // SQL query to select male residents
    $sql = "SELECT * FROM tbl_resident WHERE Sex = 'Male'";
    $view = $resident->getAll($sql);
...
<body id="page-top">
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-modal/2.2.6/js/bootstrap-modalmanager.min.js"
        integrity="sha512-/HL24m2nmyI2+ccX+dSHphAHqLw60Oj5sK8jf59VWtFWZi9vx7jzoxbZmcBeeTeCUc7z1mTs3LfyXGuBU32t+w==" crossorigin="anonymous"></script>
