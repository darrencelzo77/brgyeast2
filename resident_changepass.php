...
.custom-blue {
  background-color: #1d4ed8; /* Tailwind blue-700 color */
    ...
    <body> 
        ...
        <nav class="navbar navbar-dark custom-blue  sticky-top">
            <div class="logo">
            <a href="#"><img src="assets/logos.png" alt="logo" style="height: 60px; border-radius: 50%;"/></a>
          </div>
            <a class="navbar-brand" href="resident_homepage.php" class="btn3 bg-primary" style="margin-left:10px;"><b>East Modern Site Barangay Information System</b></a>
                ...
                <div class="col-12">
                    ...
                    <div class="row margin mtop"> 
                        ...
                        <div class="col-6">   
                            ...
                            <div class="card-header bg-secondary     text-white text-center" style="font-size:30px"> Change Password </div>
                            <br>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <form method="post">
                                                ...
                                                <button class="btn2 btn-secondary" type="submit" name="resident_changepass"> Change Password </button>
                                            </form>
                                        </div>  
                                    </div>   
                                </div>
                        ...
                        <ul class="list-unstyled collapse" id="Contact-Us">
                            <li>
                                <div class="zoom">
                                    ...
                                    <img src="assets/logos.png" alt="Person" width="96" height="96" style="border-radius: 50%;">
                                        East Modern Site Barangay | (046) 509 1644
                                    </div>
                                </div>
                            </li>
                        </ul>
