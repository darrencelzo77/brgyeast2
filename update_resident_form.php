        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="municipal" value="Bagiuo City" readonly required>
                                    </div>
                                </div>
                            </div>
                    ...
                    <center><button class="btn btn-secondary" type="submit" name="add_resident" style="width: 120px; font-size: 18px; border-radius:5px;">
                            Save
                        </button>
