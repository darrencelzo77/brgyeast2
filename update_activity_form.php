            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data" onsubmit="return handleFormSubmit()">
                        ...
                        <center>
                            <button class="btn btn-secondary" type="submit" name="update_activity" style="width: 120px; font-size: 18px; border-radius:5px;">
                                Update
                            </button>
                            <a href="activities.php" class="btn btn-danger" style="width: 120px; font-size: 18px; border-radius:5px;"> Back </a>
                        </center>
                    </form>
                </div>
            </div>
