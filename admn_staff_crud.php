...
<div class="container-fluid">
    ...
    <h1 class="mb-3 text-center">Barangay Staff Data</h1>
            ...
            <div class="card"> 
                ...
                <div class="card-body"> 
                    <form method="post" class="was-validated"> 
                        ...
                        <button class="btn btn-primary" type="submit" name="add_staff" style="width: 150px; font-size: 15px; border-radius:5px; margin-left:40%;"> Submit </button>  
                    </form>      
                </div>
            </div>
        </div>
    ...
    <h1 class="mb-3 text-center">Barangay Staff Tables</h1>
                        ...
                        <?php if(is_array($view)) {?>
                            <?php foreach($view as $view) {?>
                                <tr>
                                    <td>    
                                        <form action="" method="post">
                                            <a href="update_staff_form.php?id_user=<?= $view['id_user'];?>" style="width: 70px; font-size: 14px; border-radius:5px; margin-bottom: 2px;" class="btn btn-success"> Update </a>
                                            <input type="hidden" name="id_user" value="<?= $view['id_user'];?>">
                                            <button class="btn btn-danger" type="submit" name="delete_staff"style="width: 70px; font-size: 14px; border-radius:5px;"> Archive </button>
                                        </form>
                                    </td>
                                    <td> <?= $view['email'];?> </td>
                                    <td> <?= $view['lname'];?> </td>
