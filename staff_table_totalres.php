        ...
        <div class="col">
            <form method="POST" action="">
                <div class="input-icons" >
                    ...
                    <button class="btn btn-success" name="search_totalres" style="width: 70px; font-size: 15px; border-radius:5px; margin-left:42%;">Search</button>
                    <a href="admn_resident_crud.php" class="btn btn-info" sstyle="width: 70px; font-size: 15px; border-radius:5px;">Reload</a>
            </form>
