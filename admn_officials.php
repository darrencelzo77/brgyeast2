...
<body>
    ...
    <div class="container-fluid">
        ...
        <h1 class="mb-1 text-center">Barangay Officials and Staffs Data</h1>
                        ...
                        <?php if (is_array($view)) { ?>
                            <?php foreach ($view as $view) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="" method="post">
                                            <a href="update_official_form.php?id_official=<?= $view['id_official']; ?>" class="btn btn-success"> Update </a>
                                            <input type="hidden" name="id_user" value="<?= $view['id_user']; ?>">
                                            <!--<button class="btn btn-danger" type="submit" name="delete_official"> Delete </button>-->
                                        </form>
                                    </td>
                                </tr>
                            <?php } ?>
